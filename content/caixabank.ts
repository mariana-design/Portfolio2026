export const caixabank = {
  ...
  nda: "Some of the projects below shipped and are public. Others are still under NDA — for those, I've described the thinking and the problem, without naming the product or showing its interface.",
  ...
  panels: {
    ...
    "02": {
      ...
      lead: "In banking, the happy path is never the whole story —",
      compare: {
        head: ["Happy path", "But what if…"],
        rows: [
          ["Request → validation → confirmation", "Validation → something doesn't match"],
          ["Done ✓", "Error → recovery"],
        ],
      },
      after:
        "— designing the experience means designing what happens when things don't go as expected. Here's what the real screens looked like at each state:",
      frames: [
    ...
    "03": {
      ...
      flow: ["Discover", "Download", "Return", "Understand", "Activate", "Use", "Manage"],
      after: "On return, two questions the design had to answer immediately:",
      questions: ["Where am I?", "What happens next?"],
    ...
    "04": {
      ...
      visual: "currency exchange — several banks, one button",
    ...
    "05": {
      ...
      visual: "home bills — upcoming bill, split, dispute",
